...
def create_rooms():
    """
    This funciton is used to create all the rooms that are stated in the room_dicts.py file, set all the values within the room objects and return
    ...
    for room_dict in room_dict_list:    #iterates over all the room dictionaries in the imported room_dict_list from the roomm_initialisation.py file
